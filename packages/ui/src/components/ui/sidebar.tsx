      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="text-sidebar-foreground w-[250px] bg-white p-0 [&>button]:hidden"
            style={
              {
  ...
  return (
    <main
      ...
      className={cn(
        ...
        'peer-data-[variant=inset]:min-h-[calc(100svh-theme(spacing.4))] md:peer-data-[state=collapsed]:peer-data-[variant=inset]:ml-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:mt-2 md:peer-data-[variant=inset]:shadow',
        className
      )}
      {...props}
    />
