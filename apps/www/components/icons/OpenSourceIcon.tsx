...
interface OpenSourceIconProps {
  className?: string
}

const OpenSourceIcon: React.FC<OpenSourceIconProps> = ({ className }) => (
  <svg
    ...
    viewBox="0 0 24 24"
    fill="currentColor"
    className={`icon icon-tabler icons-tabler-filled icon-tabler-brand-open-source ${className}`}
  >
